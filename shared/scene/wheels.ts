 ...
 * narrow ⌀9 / standard ⌀11–12 / wide ⌀14 bands. A face is two numbers,
 * `spokes` and `dish`, which is all that separates a dish from a mesh at the
 * size this pane draws them. A rim is authored 1 mm narrower than the tire
...
export const WHEELS: Record<string, WheelShape> = {
  ...
  'small-low-profile-saber-type': { diameterMm: 21, widthMm: 11, spokes: 5, dishMm: 1.6 }, // 42 kits
  'small-low-profile-fin-type': { diameterMm: 21, widthMm: 11, spokes: 10, dishMm: 1.2 }, // 32
  'small-low-profile-a-spoke': { diameterMm: 21, widthMm: 11, spokes: 5, dishMm: 2 }, // 23
  'small-low-profile-y-spoke': { diameterMm: 21, widthMm: 11, spokes: 6, dishMm: 1.8 }, // 14
  'small-low-profile-spiral-type': { diameterMm: 21, widthMm: 11, spokes: 8, dishMm: 1.4 }, // 9 ?
  ...
  'small-low-profile-3-spoke': { diameterMm: 21, widthMm: 8, spokes: 3, dishMm: 2.4 },

  // — Small diameter, full profile: the classic ⌀24 fitment —
  'small-vs-type': { diameterMm: 17.5, widthMm: 11, spokes: 6, dishMm: 2 }, // 20 ?
  'small-fully-cowled-type': { diameterMm: 17.5, widthMm: 11, spokes: 6, dishMm: 2.4 }, // 9 ?
  'small-tz-fully-cowled-type': { diameterMm: 17.5, widthMm: 11, spokes: 6, dishMm: 2.4 }, // 3 ?
  ...
  'small-narrow-3-spoke': { diameterMm: 17.5, widthMm: 8, spokes: 3, dishMm: 2.4 },
  ...
  'large-manta-ray-type': { diameterMm: 25.5, widthMm: 11, spokes: 8, dishMm: 1.6 }, // 18 ?
  'large-ms-i': { diameterMm: 25.5, widthMm: 11, spokes: 6, dishMm: 2.2 }, // 14 ?
  'large-teardrop-type': { diameterMm: 25.5, widthMm: 11, spokes: 5, dishMm: 2 }, // 8 ?
  'large-v-spoke': { diameterMm: 25.5, widthMm: 11, spokes: 5, dishMm: 2.4 }, // 8
  'large-tz-fully-cowled-type': { diameterMm: 25.5, widthMm: 11, spokes: 6, dishMm: 2.4 }, // 7 ?
  ...
  'large-low-profile-v-spoke': { diameterMm: 26.5, widthMm: 11, spokes: 5, dishMm: 2.4 },
  'large-narrow-v-spoke': { diameterMm: 25.5, widthMm: 8, spokes: 5, dishMm: 2.4 },
  ...
  'small-low-profile-saber-type-1st-set-low-profile-fin-type-2nd-set': { diameterMm: 21, widthMm: 11, spokes: 5, dishMm: 1.6 },
  'small-low-profile-fin-type-1st-low-profile-dish-type-2nd': { diameterMm: 21, widthMm: 11, spokes: 10, dishMm: 1.2 }
}
