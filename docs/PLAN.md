...
The 3D chunk is 141 KB gz after all of it. Not done: the poster images under `public/images/scene-poster-*.webp` still show the box car and need re-capturing once the shapes settle; the other 68 MA kits have no silhouette yet and draw the default wedge; a real thumb has still not tried the shell tap on a phone.
