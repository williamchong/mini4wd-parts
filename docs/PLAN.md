...
- M1: build encoded in the URL (versioned compact byte array → base64url, e.g. `/build#v1.…`). Zero backend; share page renders the part list and a ~~model-viewer~~ three preview of the chassis (§4.1, 2026-09-16).
