...
Not done: the poster images under `public/images/scene-poster-*.webp` still show the box car and need re-capturing once the shapes settle; the body's 45% opacity was chosen for boxes and may be too ghostly for a real shell; the other 68 MA kits have no silhouette yet and draw the default wedge.
